...
import {
  ...
  extractDateFromOCRText,
  extractShopFromOCRText,
...
export default function OCRReceiptImport({
  ...
  const [step, setStep] = useState<
    "upload" | "processing" | "result" | "error"
  >("upload");
  ...
  const handleImageUpload = async (
    ...
    try {
      ...
      if (file.size > 5 * 1024 * 1024) {
        // 5MB
        throw new Error(
          "Le fichier est trop grand (max 5MB). Veuillez redimensionner l'image.",
        );
      }
      ...
      const imageToRecognize: File | Blob = rect
        ? file
      ...
      const {
        data: { text },
      } = await worker.recognize(imageToRecognize, recognizeOptions);
      await worker.terminate();

      // Vérifier si du texte a été extrait
      if (!text || text.trim().length === 0) {
        throw new Error(
          "Aucun texte détecté dans l'image. Essayez avec une image plus nette ou mieux éclairée.",
        );
      }
        ...
        <div className="p-4">
          ...
          {step === "processing" && (
            <div className="text-center py-5">
              ...
              <p className="mt-3 text-muted">Analyse du ticket en cours...</p>
              <p className="text-muted small">
                Cela peut prendre quelques secondes selon la taille de
                l&apos;image.
              </p>
            </div>
          )}
          ...
          {step === "result" && (
            <>
                ...
                <div className="mb-4">
                  <div className="d-flex justify-content-between align-items-center mb-2">
                    ...
                    <div className="d-flex gap-2">
                      <button
                        ...
                        title={
                          useSelection
                            ? "Désactiver la sélection de zone"
                            : "Sélectionner une zone pour l'OCR"
                        }
                      >
                        <i
                          className={`bi ${useSelection ? "bi-bounding-box-circles" : "bi-upc-scan"}`}
                        ></i>
                  ...
                  >
                    <img
                      ...
                      style={{
                        ...styles.previewImage,
                        cursor: useSelection ? "crosshair" : "default",
                      }}
                      ref={imageRef}
                  ...
                  {useSelection && (
                    <p className="text-muted small mt-2">
                      Cliquez et faites glisser pour sélectionner la zone à
                      analyser, puis cliquez sur "Appliquer"
                    </p>
                  )}
                </div>
              )}
                ...
                {extractedAmount !== null ? (
                  <div className="mb-3">
                    <div className="d-flex justify-content-between align-items-center mb-2">
                      ...
                      <span className="h4 mb-0" style={{ color: "#0d6efd" }}>
                  ...
                  <div className="alert alert-warning mb-3">
                    ...
                    Aucun montant détecté. Vérifiez que le total est visible sur
                    l&apos;image.
                  </div>
                )}
              ...
              <div className="d-flex gap-2 mt-4">
                ...
                <button className="btn btn-outline-secondary" onClick={retry}>
          ...
          {step === "error" && (
            <div className="text-center py-4">
              ...
              <p className="text-muted mb-4">
                ...
                {error?.includes("Tesseract") && (
                  <>
                    <br />
                    <small>
                      Astuce: La bibliothèque OCR (Tesseract.js) est en cours de
                      chargement. Cela peut prendre quelques secondes à la
              ...
              <div className="d-flex gap-2">
                <button className="btn btn-primary flex-grow-1" onClick={retry}>
                  <i className="bi bi-arrow-clockwise me-1"></i>Réessayer
                </button>
                <button className="btn btn-outline-secondary" onClick={onClose}>
                  Annuler
